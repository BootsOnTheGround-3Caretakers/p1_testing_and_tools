...
var request_time = 0;
var request_url = "https://p1s3-web-requests-dot-aqueous-choir-160420.appspot.com/p1s3t9-add-modify-user-to-existing-cluster";

var params = {
    // p1s3_firebase_email: configs.user_email,
    // p1s3_token: '',
    p1s3t9_cluster_uid: '5733636452122624',
    p1s3t9_user_uid: '5709624632147968',
    p1s3t9_roles: ''
};

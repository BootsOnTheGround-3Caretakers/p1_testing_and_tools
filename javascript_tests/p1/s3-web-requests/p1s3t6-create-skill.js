...
var request_time = 0;
var request_url = "https://p1s3-web-requests-dot-aqueous-choir-160420.appspot.com/p1s3t6-create-skill";

var params = {
    p1s3_firebase_email: configs.user_email,
    p1s3_token: '',
    p1s3t6_skill_name: 'Surgeon',
    p1s3t6_description: 'Senior Surgeon',
    p1s3t6_skill_type: 'a',
    p1s3t6_certification_needed: 'MBBS'
};

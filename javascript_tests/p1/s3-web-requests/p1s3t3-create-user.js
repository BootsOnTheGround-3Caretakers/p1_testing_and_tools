...
var request_time = 0;
var request_url = "https://p1s3-web-requests-dot-aqueous-choir-160420.appspot.com/p1s3t3-create-user";

var params = {
    p1s3_firebase_email: configs.user_email,
    p1s3_token: '',
    p1s3t3_first_name: 'Minnie',
    p1s3t3_last_name: 'Mouse',
    p1s3t3_phone_number: '+62815111111',
};

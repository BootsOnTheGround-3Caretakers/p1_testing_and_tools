...
var request_time = 0;
var request_url = "https://p1s3-web-requests-dot-aqueous-choir-160420.appspot.com/p1s3t1-create-need";

var params = {
    p1s3_firebase_email: configs.user_email,
    p1s3_token: '',
    p1s3t1_name: 'Sanitizer',
    p1s3t1_requirements: 'Hand Sanitizer for single person',
};
